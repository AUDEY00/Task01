...
app.controller("MapController", function ($scope, $mdDialog) {
    ...
    // Available Mapbox views:
    // "palawan"
    // "philippines"
    // "world"

    vm.mapView =
        localStorage.getItem("mapView") || "palawan";
    ...
    function initializeMapbox() {
        ...
        map.on("load", function () {
            ...
            // Apply the selected Mapbox view.
            vm.changeMapView();
    ...
    vm.changeMapView = function () {

        // This function only applies to Mapbox.
        if (
        ...
        // Remember the selected map view.
        ...
        else if (vm.mapView === "philippines") {
    ...
    vm.goToGeneralLists = function () {
        window.location.href = "general-list.html";
    };
    ...
    vm.startMapTour = function () {
        ...
        var driverObj = driver({
            ...
            steps: [
                ...
                {
                    element: "#map-tour-navigation",
                    popover: {
                        title: "Map Navigation",
                        description:
                            "Use the sidebar to move between the Dashboard and Location Map.",
                        side: "right",
                        align: "start"
                    }
                },
                ...
                {
                    element: "#tour-map-provider",
                    popover: {
                        title: "Map Provider",
                        description:
                            "Choose which map engine you want to use. The system supports both Mapbox and Leaflet while using the same location records.",
                        side: "bottom",
                        align: "start"
                    }
                },
                ...
                {
                    element: "#tour-map-view",
                    popover: {
                        title: "Map View",
                        description:
                            "When Mapbox is selected, use this control to change the geographic view between Palawan, the Philippines, and the World.",
                        side: "bottom",
                        align: "start"
                    }
                },

                {
                    ...
                    popover: {
                        ...
                        description:
                            "This is the interactive map. You can view saved locations, interact with markers, and click on the map to select coordinates.",
                        side: "top",
                        align: "start"
                    }
                },
                ...
                {
                    element: "#tour-add-location",
                    popover: {
                        title: "Add Location",
                        description:
                            "Enter a location name, latitude, and longitude to create a new location record. You can also select coordinates directly from the map.",
                        side: "top",
                        align: "start"
                    }
                },

                {
                    ...
                    popover: {
                        ...
                        description:
                            "All registered locations are displayed here, including their coordinates, creation date, and modification date.",
                        side: "top",
                        align: "start"
                    }
                },
                ...
                {
                    element: "#tour-location-table .action-buttons",
                    popover: {
                        title: "Location Actions",
                        description:
                            "Use Edit to update a location or Delete to remove it. Clicking a location row can also focus the corresponding location on the map.",
                        side: "left",
                        align: "start"
                    }
                },
                ...
                {
                    element: "#map-tour-logout",
                    popover: {
                        title: "Logout",
                        description:
                            "Use the Logout button when you are finished using the system.",
                        side: "right",
                        align: "start"
                    }
                },

                {
                    popover: {
                        ...
                        description:
                            "You now know how to navigate the map, switch map providers, change map views, add locations, and manage existing location records."
                    }
                }
